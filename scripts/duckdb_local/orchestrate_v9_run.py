...
Core AutoGluon card (scripts/duckdb_local/cards/core_training/2026_05_09_warbird_pro_autogluon_core.py)
...
CARDS = [
    ("warbird_pro_v9_exit_cpcv", "scripts.duckdb_local.warbird_pro_v9_exit_cpcv_profile",
     "Warbird Pro V9 Exit Policy CPCV"),
    ("warbird_pro_v9_entry_filter_cpcv", "scripts.duckdb_local.warbird_pro_v9_entry_filter_cpcv_profile",
     "Warbird Pro V9 Entry Filter CPCV"),
    ("warbird_pro_v9_ag_meta_cpcv", "scripts.duckdb_local.warbird_pro_v9_ag_meta_cpcv_profile",
     "Warbird Pro V9 AG Meta CPCV"),
    ("warbird_pro_v9_joint_challenger", "scripts.duckdb_local.warbird_pro_v9_joint_challenger_profile",
...
def build_candidate_manifest(top_k: int = 5) -> list[dict[str, Any]]:
    ...
    scripts/duckdb_local/workspaces/warbird_pro_v9_ag_meta_cpcv/strategy_candidates.json
        ...
        "cards": [
            {
                ...
                "study_db": f"scripts/duckdb_local/workspaces/{key}/study.db",
            }
...
def main() -> int:
    ...
    print(f"  python scripts/duckdb_local/promote_v9_champion.py --run-id {run_id}")
    return 0
