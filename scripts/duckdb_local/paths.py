#!/usr/bin/env python3
"""Canonical path helpers for the Warbird local DuckDB modeling workspace
(renamed from scripts/optuna/ on 2026-05-12)."""
...
DUCKDB_LOCAL_ROOT = REPO_ROOT / "scripts" / "duckdb_local"
WORKSPACES_ROOT = DUCKDB_LOCAL_ROOT / "workspaces"
ARCHIVE_ROOT = DUCKDB_LOCAL_ROOT / "archive"
