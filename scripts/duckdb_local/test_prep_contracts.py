...
from scripts.duckdb_local import paths
from scripts.duckdb_local import warbird_pro_v9_profile as v9_profile

core_card = importlib.import_module(
    "scripts.duckdb_local.cards.core_training.2026_05_09_warbird_pro_autogluon_core"
)
