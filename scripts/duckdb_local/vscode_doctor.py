...
from scripts.duckdb_local.paths import WORKSPACES_ROOT, study_db_path

REGISTRY_PATH = REPO_ROOT / "scripts" / "duckdb_local" / "indicator_registry.json"
...
def main() -> None:
    ...
    print("- current-runtime-only health: `python scripts/duckdb_local/runtime_health.py`")
    print("- stale log cleanup: `python scripts/duckdb_local/prune_runtime_logs.py --apply`")
