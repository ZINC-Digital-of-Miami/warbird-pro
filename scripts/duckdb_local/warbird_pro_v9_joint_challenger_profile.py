...
`warbird_pro_core` entry in scripts/duckdb_local/indicator_registry.json.
...
raise SystemExit(
    ...
    "Use scripts/duckdb_local/cards/core_training/2026_05_09_warbird_pro_autogluon_core.py instead."
)
...
from scripts.duckdb_local import warbird_pro_v9_profile as _strategy_base
from scripts.duckdb_local.cpcv_helpers import ag_embargoed_train_and_score
from scripts.duckdb_local.paths import workspace_dir
from scripts.duckdb_local.warbird_pro_v9_ag_meta_cpcv_profile import (
    LABEL_COL,
    ML_FEATURES,
